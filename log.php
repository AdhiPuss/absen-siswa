        ...
        <div class="main-header" style="background-color: #1269DB;">
            ...
            <div class="container">
                <div class="logo-header" data-background-color="blue2">
                    ...
                    <a href="index.php">
                        <img src="assets/img/telkom.png" alt="navbar brand" class="navbar-brand" width="40">
                    ...
                    <div class="container">
                        <div class="page-inner py-5">
                            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                <div>
                                    <h2 class="text-white pb-2 fw-bold">SMK TELKOM PURWOKERTO</h2>
                                    <!-- <h5 class="text-white op-7 mb-2">Absen Lebih mudah gunakan Aplikasi Absensi</h5> -->
                                </div>
                                <div class="ml-md-auto py-2 py-md-0">
                                    <a href="https://smktelkom-pwt.sch.id/helpdesk/" class="btn btn-white btn-border btn-round mr-2">Jl. DI Panjaitan No.128, Karangreja, Purwokerto Kulon,<br> Kec. Purwokerto Sel., Kabupaten Banyumas, Jawa Tengah</a>
                                ...
                                <div class="card-body">
                                    <form action="" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="admin/index.php" class="btn btn-danger btn-block"><i
            ...
            <footer class="footer">
                <div class="container">
                    <div class="copyright ml-auto">
                        &copy; <?php echo date('Y');?> MyAbsensi.<a href="admin/index.php">TELKOM SCHOOL </a> | 53141
                    </div>
                </div>
            </footer>
