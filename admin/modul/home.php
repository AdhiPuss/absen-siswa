					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Selamat Datang di MyAbsensi, <b class="text-warning"><?=$data['nama_lengkap']; ?></b> | Aplikasi Absensi Siswa</h5>
							</div>
							...
							<div class="card full-height">
								<div class="card-body">
									<div class="card-title">
										<center>
											<img src="../assets/img/telkom.png" width="80">
											<br>
									...
									<div class="card-category">
										<center>
										Jl. DI Panjaitan No.128, Karangreja, Purwokerto Kulon, Kec. Purwokerto Sel., Kabupaten Banyumas, Jawa Tengah 53141
	<br>Instagram : @stematelpwt Telp : 081234567890
										</center>
									</div>
